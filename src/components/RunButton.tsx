...
const Button = () => {
  return (
    <StyledWrapper>
      <button className="button scale-75">
        <span>Run</span>
...
const StyledWrapper = styled.div`
  .button {
    --main-size: 2em;
    --color-text: var(--primary-foreground);
    --color-background: var(--primary);
    --color-background-hover: hsl(from var(--primary) h s calc(l * 1.1));
    --color-outline: hsl(from var(--primary) h s l / 0.25);
    --color-shadow: hsl(0 0% 0% / 0.25);
    cursor: pointer;
    display: flex;
